...
/*
============================================================================
FILE : ESP32 WEB SERVER
AUTHOR : Christian Andrie Asne
DESCRIPTION : A program for establishing wifi connection through website 
using ESP32 board
============================================================================
*/
...
const char* ssid     = "Christian Andrie Asne";
...
void setup() {
  ...
  digitalWrite(2, 0);      // turn LED off by default
  pinMode(2, OUTPUT);      // set the LED pin mode
  digitalWrite(2, 0);      // turn LED off by default
